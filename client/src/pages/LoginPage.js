...
function LoginPage({ setIsLogin, setMemberId }) {
  return (
    <>
      <Maindiv>
        <SofIcon>
        ...
        <SocialLogin />
        <LoginForm setIsLogin={setIsLogin} setMemberId={setMemberId} />
        <div className="mx-auto ta-center fs-body1 p16 pb0 mb24 w100 wmx3">
          ...
          <div className="mt12">
            ...
            <a href="https://careers.stackoverflow.com/employer/login" name="talent">
              Sign up on Talent
              <svg aria-hidden="true" className="va-text-bottom sm:d-none svg-icon iconShareSm" width="14" height="14" viewBox="0 0 14 14">
